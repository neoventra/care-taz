...
@section('title', 'Palliative &amp; End-of-Life Care at Home | Caretaz Healthcare')
@section('description', 'Gentle, respectful palliative and end-of-life home care in Nottingham — comfort, dignity and family reassurance from CQC-regulated Caretaz carers.')
...
<section class="sd-hero" aria-labelledby="sd-hero-heading">
      <div class="sd-hero__bg" style="background-image:url('../assets/images/care-palliative-banner.jpg')" aria-hidden="true"></div>
      <div class="sd-hero__inner">
        <nav class="breadcrumbs" aria-label="Breadcrumb">
          <a href="{{ route('home') }}">Home</a> <span>/</span>
          <a href="{{ route('home') }}">Services</a> <span>/</span>
          <span>Palliative / End-of-Life Care</span>
        </nav>
        <p class="sd-brand">Caretaz Healthcare · Palliative &amp; End-of-Life Care</p>
        <h1 id="sd-hero-heading">Comfort first. Presence that <em>honours</em>.</h1>
        <p class="sd-hero__lead">Sensitive home support focused on dignity, calm routines and family reassurance in life’s most meaningful moments.</p>
        <div class="btn-row">
      ...
      <div class="container">
        <div class="sd-trust__grid">
          <div class="sd-trust__card reveal">
            ...
            <span class="sd-trust__label">Symptom-aware support</span>
          </div>
          <div class="sd-trust__card reveal">
            <strong>Family</strong>
            <span class="sd-trust__label">Liaison &amp; guidance</span>
          </div>
          <div class="sd-trust__card reveal">
            <strong>Flex</strong>
            <span class="sd-trust__label">Presence as needed</span>
          </div>
          <div class="sd-trust__card reveal">
            <strong>CQC</strong>
            <span class="sd-trust__label">Regulated care</span>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="sd-split">
          <div class="sd-split__media reveal-left">
            <img src="{{ asset('assets/images/care-palliative-about.jpg') }}" alt="Palliative and End-of-Life Care at home with Caretaz Healthcare" width="720" height="540" loading="eager">
            <div class="sd-split__float">
              <strong>Dignity</strong>
              <span>Comfort-led care</span>
            </div>
          </div>
          <div class="sd-split__copy reveal-right">
            <p class="eyebrow">About this service</p>
            <h2 id="about-service">Care that protects comfort and humanity.</h2>
            <p>Palliative and end-of-life care from Caretaz centres on comfort, dignity and emotional support — for the person and for the family around them.</p>
            <p>We deliver calm personal care, comfort routines and sensitive communication, coordinating with healthcare professionals so wishes guide every decision.</p>
            <p>The aim is quality of life: making each day as comfortable, peaceful and person-centred as possible at home.</p>
            <div class="sd-pill-row">
              <span class="sd-pill"><i></i> Comfort care</span>
              <span class="sd-pill"><i></i> Family support</span>
              <span class="sd-pill"><i></i> Quiet presence</span>
              <span class="sd-pill"><i></i> Team coordination</span>
            </div>
            <div class="btn-row">
      ...
      <div class="container">
        ...
        <div class="sd-includes">
          <article class="sd-include reveal">
            ...
            <h3>Gentle personal care</h3>
            <p>Unhurried support that prioritises ease and dignity.</p>
          </article>
          <article class="sd-include reveal">
            <span class="sd-include__label">Daily</span>
            <h3>Comfort routines</h3>
            <p>Positioning, mouth care, hydration and settling rituals.</p>
          </article>
          <article class="sd-include reveal">
            <span class="sd-include__label">Heart</span>
            <h3>Companionship</h3>
            <p>Quiet company, listening and presence without rush.</p>
          </article>
          <article class="sd-include reveal">
            <span class="sd-include__label">Family</span>
            <h3>Relative liaison</h3>
            <p>Clear updates and space for families to be involved.</p>
          </article>
          <article class="sd-include reveal">
            <span class="sd-include__label">Team</span>
            <h3>Wider coordination</h3>
            <p>Working alongside nurses, GPs and specialist teams.</p>
          </article>
          <article class="sd-include reveal">
            <span class="sd-include__label">Flex</span>
            <h3>Adaptive presence</h3>
            <p>Increase visits or overnight cover as needs intensify.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="sd-values">
          <article class="sd-value reveal">
            ...
            <p>Every visit prioritises ease, calm and dignity.</p>
          </article>
          <article class="sd-value reveal">
            <div class="sd-value__num">02</div>
            <h3>Family support</h3>
            <p>Guidance and reassurance for those closest.</p>
          </article>
          <article class="sd-value reveal">
            <div class="sd-value__num">03</div>
            <h3>Flexible presence</h3>
            <p>Scale support as circumstances change.</p>
          </article>
          <article class="sd-value reveal">
            <div class="sd-value__num">04</div>
            <h3>Respectful care</h3>
            <p>Wishes, culture and identity always honoured.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="sd-faq">
          <details class="reveal">
            <summary>Is palliative care only for the final days?</summary>
            <div class="sd-faq__body">No. Palliative support can begin earlier to improve comfort and quality of life, then intensify as needs change.</div>
          </details>
          <details class="reveal">
            <summary>Do you work with hospice or district nurses?</summary>
            <div class="sd-faq__body">Yes. We coordinate with clinical teams so home care complements medical support.</div>
          </details>
          <details class="reveal">
            <summary>Can care include overnight presence?</summary>
            <div class="sd-faq__body">Yes. Many families add overnight or continuous cover so someone trusted is always near.</div>
          </details>
          <details class="reveal">
            <summary>How do you support families emotionally?</summary>
            <div class="sd-faq__body">With honest communication, space to be present, and practical help that lifts the load of daily care tasks.</div>
          </details>
        </div>
      </div>
    </section>
    ...
    <section class="sd-section" aria-labelledby="related-heading">
      <div class="container">
        ...
        <div class="sd-related">
          <a class="reveal" href="{{ route('services.show', 'cancer-care') }}">
            <div class="sd-related__media"><img src="{{ asset('assets/images/care-health-check.jpg') }}" alt="Cancer Care" width="640" height="360" loading="lazy"></div>
      ...
      <div class="container">
        <div class="sd-finale reveal">
          <div>
            ...
            <h2>When comfort matters most, we’re here.</h2>
            <p>Speak with our team discreetly — we’ll listen first, then shape gentle support at home.</p>
            <div class="btn-row">
          ...
          <div class="sd-finale__media">
            <img src="{{ asset('assets/images/care-health-check.jpg') }}" alt="Caretaz caregiver" width="560" height="360" loading="lazy">
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="form-grid">
            ...
            <div class="form-field"><label for="service">Select Services</label>
              <select id="service" name="service" required>
                ...
                <option selected>Palliative / End-of-Life Care</option>
